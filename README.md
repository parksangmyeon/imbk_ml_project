...
1차 클러스터링을 통해 대구·경북 내부의 우수 고객군을 먼저 정의했습니다.  
이후 해당 대구·경북 우수 고객군과 타지역 고객 데이터를 결합하여 2차 KMeans 클러스터링을 수행했습니다.

2차 클러스터링의 K값은 Elbow와 Silhouette 분석을 함께 고려하여 선정했습니다.

![2nd Elbow](images/2nd_elbow.png)

![2nd Silhouette](images/2nd_silhouette.png)

2차 클러스터링 이후, 나뉜 군집 중에서 대구·경북 우수 고객군이 가장 많이 포함된 클러스터를 최종 분석 군집으로 선택했습니다.  
이 클러스터에 함께 묶인 타지역 고객군은 대구·경북 우수 고객군과 금융 구조가 유사할 가능성이 높은 집단으로 해석했습니다.

즉, 2차 클러스터링은 대구·경북 우수 고객군과 유사한 타지역 고객 후보군을 추출하기 위한 과정입니다.
---

## 10. Cosine Similarity Analysis

2차 클러스터링에서 선택된 최종 군집 중 **타지역 고객군만 추출**한 뒤,  
이들을 기존 대구·경북 우수 고객군의 금융 패턴과 비교했습니다.

비교 기준은 대구·경북 우수 고객군의 금융 지표 중앙값 벡터이며,  
